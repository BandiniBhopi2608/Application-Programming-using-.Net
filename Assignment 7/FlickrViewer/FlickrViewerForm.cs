...
namespace FlickrViewer
{
    public partial class FlickrViewerForm : Form
    {
        ...
        private const string KEY = "33676ad5561e0f5e14729b546f27a61b";
        ...
        private async void searchButton_Click(object sender, EventArgs e)
        {
            ...
            var flickrURL = string.Format("https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key={0}&tags={1}&" +
           ...
           object sender, EventArgs e)
        {
            if (imagesListBox.SelectedItem != null)
            {
                ...
                byte[] imageBytes = await objClient.DownloadDataTaskAsync(selectedURL);
